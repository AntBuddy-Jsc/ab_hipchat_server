...
%%AB#43
-define(NS_MAM_UPDATE_STATUS, <<"urn:xmpp:mam:1#update_status">>).
-define(NS_MAM_COUNT_UNREAD_MESSAGE, <<"urn:xmpp:mam:1#countmsg">>).
-define(NS_MAM_ACTIVE_ROOM, <<"urn:xmpp:mam:1#active_room">>).
-define(NS_MAM_CURRENT_TIME, <<"urn:xmpp:mam:1#current_time">>).
-define(NS_MAM_KITE_ACTIVE_ROOM, <<"urn:xmpp:mam:1#kite_active_room">>).
